...
User.prototype.validate = function(){
    return new Promise(async (resolve,reject) => {
        if(this.data.username == ""){this.errors.push("You must a provide a username.")}
        ...
        if(!validator.isEmail(this.data.email)){this.errors.push("You must a provide a valid email address.")}
        if(this.data.password == ""){this.errors.push("You must a provide a password")}
...
User.prototype.register = function(){
    return new Promise(async (resolve,reject) => {
        ...
        // Step #2: Only if thee are no validation errors
